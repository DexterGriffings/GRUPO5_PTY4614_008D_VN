...
from . import views
from .views import home_view, authenticated_home_view, eliminar_alumno,guardar,envio,generar_excel_desde_datos, completar_colegios,obtener_datos_cuestionario,generar_excel
...
urlpatterns = [
    ...
    path('eliminar-alumno/', eliminar_alumno, name='eliminar_alumno'),
